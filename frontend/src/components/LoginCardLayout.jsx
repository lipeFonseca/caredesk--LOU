...
//
// LIMITAÇÃO: o lugar natural deste arquivo é components/login/, junto do
// loginPageBackground. Essa pasta está com a ACL do Windows quebrada — nega até
// escrita em arquivo existente — e a correção exige shell elevado. A versão
// antiga continua lá, órfã, até isso ser resolvido. Mesmo caso do LoginPageShell.
