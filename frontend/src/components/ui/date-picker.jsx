...
export default function DatePickerField({ value, onChange, placeholder = 'dd/mm/aaaa', disabled = false }) {
  ...
  return (
    <div ref={containerRef} className="relative">
      <div
        className="flex items-center gap-1 rounded-2xl border border-transparent bg-transparent py-2 pl-4 pr-1.5 transition-colors
          hover:bg-surface-container-low/60 focus-within:border-primary/60 focus-within:bg-surface-container-low focus-within:ring-4 focus-within:ring-primary-100/60
      ...
      >
        <input
          ...
          className="min-w-0 flex-1 bg-transparent py-1 text-base text-on-surface outline-none placeholder:text-on-surface-variant/70 disabled:cursor-not-allowed"
        />
        {value && !disabled && (
          <button
            type="button"
